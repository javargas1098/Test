...
public class SwaggerConfiguration {
    ...
    private ApiInfo apiInfo() {
        ApiInfo apiInfo = new ApiInfo("My REST API", "Some custom description of API.", "API TOS", "Terms of service", new Contact("Javier Vargas","demo", "ja.vargas1098@gmail.com"), "License of API", "API license URL", Collections.emptyList());
        return  apiInfo;
    }
